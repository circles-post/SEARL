...
python -m verl.model_merger merge \
    --backend fsdp \
    --local_dir /mnt/shared-storage-user/ai4good2-share/fengxinshun/saves/mgpo_hazard_rnn_g0.5_all_span/global_step_87/actor \
    --target_dir /mnt/shared-storage-user/ai4good2-share/fengxinshun/saves/mgpo_hazard_rnn_g0.5_all_span
```
