...
class SEARLToolcall(MultiTurnScheduler):
...
multi_turns['searl_toolcall'] = SEARLToolcall


if __name__ == "__main__":
    searl = SEARLToolcall()
    searl.env_object.step(['message <tool_call>{"name": "query_rag", "arguments": {"query": "who is the 14th president of nigeria"}}</tool_call>'])
