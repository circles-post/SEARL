...
[📘Tutorial](docs/rl_factory/en/main_tutorial.md) &#124; [🛠️Installation](docs/rl_factory/en/install.md) &#124; [🎨Framework](docs/rl_factory/en/framework_design.md) &#124; [🏆Model](https://huggingface.co/Simple-Efficient/SEARL-Qwen3-8B-GRPO)

</div>

--- 

SEARL is an **easy** and **efficient** RL post-training framework for **Agentic Learning**. 

SEARL decouples the environment from RL post-training, enabling training with just a tool config and reward function while supporting async tool-calling to make RL post-training **2x faster**.
...
+ **Version 0.2** We are looking forward to more people participating in the development and construction together, to create a great Agenetic Training community. Please feel free to contact us.
  + **WebUI**: build a WebUI for data processing, tool & environment definition, training configuration, and project management [#2](https://github.com/Simple-Efficient/SEARL/issues/2)
  + **More efficient training**: support the AsyncLLMEngine for more efficient rollout [#4](https://github.com/Simple-Efficient/SEARL/issues/4)
  + **More models**: test more models (such as Deepseek, Llama, etc.) and add corresponding support configurations [#5](https://github.com/Simple-Efficient/SEARL/issues/5)
  + **Process Reward**: use process reward to better guide the tool-call behavior of your model [#6](https://github.com/Simple-Efficient/SEARL/issues/6)
  ...
  + **Multimodal agentic learning**: support multimodal (image) agent training in terms of functionality [#66](https://github.com/Simple-Efficient/SEARL/issues/66)
  + **Android Environment**: added Android OS environment support [#38](https://github.com/Simple-Efficient/SEARL/pull/38)
  + **Tools cache**: cached tool invocation results to enhance post-processing efficiency [#57](https://github.com/Simple-Efficient/SEARL/pull/57)
  + **Handy evaluation**: added main_eval.sh for evaluation utility [#36](https://github.com/Simple-Efficient/SEARL/pull/36)
  + **Upgrade to VeRL-0.5**: Upgraded to VeRL-0.5 with maximal component decoupling [update/verl_0_5](https://github.com/Simple-Efficient/SEARL/tree/update/verl_0_5)
  + **Add MS-SWIFT-3.7 to SEARL**: Added the support of MS-SWIFT-3.7 to make it more convenient for individual developers [#95](https://github.com/Simple-Efficient/SEARL/pull/95)
...
+ In [`docs/rl_factory/main_tutorial.md`](docs/rl_factory/main_tutorial.md), we provide an SEARL reproduction example of [Search-R1](https://github.com/PeterGriffinJin/Search-R1). We use `Qwen3-4B` and `Qwen3-8B` as the base model for RL training. 
...
+ The table below presents our training results under identical computational resources, software, and verl versions
  + SEARL trains in about half the time of Search-R1, demonstrating high efficiency.
...
| **SEARL-Qwen3-4B-GRPO** | **0.458** | **5.30 h** | **190 s** | A100 × 8 | 
| **SEARL-Qwen3-8B-GRPO** | **0.463** | **5.76 h** | **207 s** | A100 × 8 | 
...
## How to contribute?
We welcome all users and developers to contribute code to SEARL. If you have any questions, encounter bugs, or would like to collaborate on development, please feel free to contact us!
...
<div align="center">
  <img src="https://github.com/Simple-Efficient/SEARL/blob/main/assets/we_group3.jpg" alt="Description" style="width:200px; height:auto;"/>
...
```
@misc{chai2025searlplugandplayreinforcementlearning,
      title={SEARL: A Plug-and-Play Reinforcement Learning Post-Training Framework for LLM Multi-Turn Tool-Use}, 
...
## Star History
[![Star History Chart](https://api.star-history.com/svg?repos=Simple-Efficient/SEARL&type=Date)](https://www.star-history.com/#Simple-Efficient/SEARL&Date)  
